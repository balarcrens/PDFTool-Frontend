                ...
                >
                  ...
                  <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-3xl font-black text-slate-900">PDF Document Compiled</h3>
                      <p className="text-slate-500 font-medium max-w-md mx-auto">Your assets have been successfully converted into a high-fidelity document.</p>
                    </div>
                  </div>
