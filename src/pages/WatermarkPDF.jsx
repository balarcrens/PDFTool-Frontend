                ...
                <AnimatePresence>
                    {watermarkedPdfUrl && (
                        ...
                        >
                            ...
                            <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-2">Watermark Applied</h3>
                            <p className="text-slate-500 font-medium max-w-md mb-8">
                                Your high-fidelity watermark layers have been successfully drawn. Save your local copy below.
                            </p>

                            <div className="premium-file-details max-w-xl">
                                <div className="text-left">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Watermarked Document</p>
                                    <p className="font-bold text-slate-800 text-sm truncate max-w-[200px] sm:max-w-[300px]">watermarked_{file.name}</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Status</p>
                                    <p className="font-bold text-indigo-600 text-sm">Stamp Rendered</p>
                                </div>
                            </div>
                            ...
                            >
                                <RefreshCcw className="w-3.5 h-3.5" /> Watermark Another File
                            </button>
                        </motion.div>
                    )}
                </AnimatePresence>
