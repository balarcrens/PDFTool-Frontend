...
export default function Home() {
  ...
  const faqs = [
    {
      question: "Is PDFTool completely free to use?",
      answer: "Yes, PDFTool is 100% free with no signups, subscription models, or hidden fees. Since execution happens on your own device rather than our servers, we have no recurring hosting overhead, allowing us to keep the entire platform free of charge."
    },
    {
      question: "How does browser-local processing work?",
      answer: "Traditional utility sites upload your documents to external cloud clusters for processing. PDFTool uses advanced client-side scripts (PDF.js, PDF-lib) executed directly within your browser window. Your files are loaded into RAM, processed locally by your computer's CPU, and saved, meaning they never touch our servers and remain 100% secure."
    },
    {
      question: "What file formats does PDFTool support?",
  ...
  return (
    <>
      <SEO 
        title="Secure Local PDF Solutions"
        description="Do anything with PDF 100% locally in your browser. Compress, merge, split, organize, extract text, and convert PDFs to Word or images with absolute privacy."
        keywords="free pdf tools, secure pdf merge, compress pdf locally, convert word to pdf, pdf to word, local pdf editor"
      />
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <p className="text-slate-500 text-lg leading-relaxed font-medium max-w-xl">
                Unlike cloud-based solutions, PDFTool processes every document locally in your browser. This means absolute privacy, zero upload wait times, and compliance with strict corporate security policies.
              </p>
            </div>
        ...
        <div className="bg-[#0047AB] rounded-[2.5rem] p-12 md:p-20 text-center text-white relative overflow-hidden shadow-2xl shadow-indigo-100">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <p className="text-indigo-100 text-lg max-w-xl mx-auto font-medium">
              Join thousands of professionals who trust PDFTool for their business-critical documents.
            </p>
