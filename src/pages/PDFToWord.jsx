						...
						<AnimatePresence>
							{docUrl && stats && (
								...
								>
									...
									<h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-2">Conversion Successful</h3>
									...
									<div className="premium-file-details max-w-xl">
										<div className="text-left">
											<p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Generated Document</p>
											<p className="font-bold text-slate-800 text-sm truncate max-w-[200px] sm:max-w-[300px]">{stats.fileName}</p>
										</div>
										<div className="text-right">
											<p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Format</p>
											<p className="font-bold text-indigo-600 text-sm">Microsoft Word (.doc)</p>
										</div>
									</div>
									...
									<div className="premium-actions-layout">
										...
										>
											<span className="btn-premium-action-text flex items-center gap-2">
												<Eye className="w-4 h-4" /> Verify Result
											</span>
											<span className="btn-premium-action-subtext">In-Browser Markup</span>
										</button>
									...
									>
										<RefreshCcw className="w-3.5 h-3.5" /> Convert Another File
									</button>
								</motion.div>
							)}
						</AnimatePresence>
