                        ...
                        <AnimatePresence>
                            {protectedPdfUrl && (
                                ...
                                >
                                    ...
                                    <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-2">Document Secured</h3>
                                    <p className="text-slate-500 font-medium max-w-md mb-8">
                                        Your PDF has been successfully encrypted and is now restricted from unauthorized access.
                                    </p>

                                    <div className="premium-file-details max-w-xl">
                                        <div className="text-left">
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Encrypted Output</p>
                                            <p className="font-bold text-slate-800 text-sm truncate max-w-[200px] sm:max-w-[300px]">protected_{file.name}</p>
                                        </div>
                                        <div className="text-right">
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Security Mode</p>
                                            <p className="font-bold text-emerald-600 text-sm">AES Password Locked</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="premium-actions-layout">
                                        ...
                                        >
                                            <span className="btn-premium-action-text flex items-center gap-2">
                                                <Eye className="w-4 h-4" /> Verify Access
                                            </span>
                                        ...
                                        >
                                            ...
                                            <span className="btn-premium-action-subtext">Permanent Save</span>
                                        </a>
                                    </div>
                                    ...
                                    >
                                        <RefreshCcw className="w-3.5 h-3.5" /> Protect Another File
                                    </button>
                                </motion.div>
                            )}
                        </AnimatePresence>
