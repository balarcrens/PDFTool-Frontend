    ...
    <>
      ...
      <div className="container-professional space-y-16 py-16 md:py-24">
        ...
        <div className="text-center space-y-6">
          ...
          >
            <FileImage className="w-3.5 h-3.5 text-[#0047AB]" />
            ...
            <div className="action-bar-classic sticky top-24 z-30">
              <div className="flex flex-col md:flex-row items-center gap-6 w-full md:w-auto">
                <div className="flex bg-slate-100 p-1 rounded-xl border border-slate-200">
                  <button
                    ...
                    className={cn(
                      ...
                      format === "image/png" ? "bg-white text-slate-900 shadow-sm" : "text-slate-400"
                    )}
                  >
                    PNG
                  </button>
                  <button
                    ...
                    className={cn(
                      "px-6 py-2 text-[10px] font-bold uppercase tracking-widest rounded-lg transition-all",
                      format === "image/jpeg" ? "bg-white text-slate-900 shadow-sm" : "text-slate-400"
                    )}
                  >
                    JPG
                  </button>
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Source Document</span>
              ...
              >
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 px-4">
                  <div className="space-y-1 text-center md:text-left">
                    ...
                    <p className="text-slate-400 font-bold text-[10px] uppercase tracking-widest">Available for high-quality export</p>
                  </div>
                  <button
                    onClick={downloadAll}
                    className="w-full md:w-auto flex items-center justify-center gap-3 px-10 py-4 bg-[#0047AB] text-white rounded-2xl font-bold text-[11px] uppercase tracking-widest hover:bg-[#003580] transition-all shadow-xl shadow-indigo-100"
                  >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
                  {images.map((img, i) => (
                    <motion.div
                      ...
                      className="group relative aspect-[3/4] rounded-2xl overflow-hidden border border-slate-100 shadow-sm hover:border-[#0047AB] transition-all duration-300"
                    >
                      ...
                      <div className="absolute inset-0 bg-slate-900/60 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center backdrop-blur-[2px]">
                        <a
                          ...
                          title="Download Page"
                        >
                          <Download className="w-5 h-5 text-[#0047AB]" />
                        </a>
                      </div>
