                        ...
                        {isGeneratingPreviews ? (
                            <div className="flex flex-col items-center justify-center py-40 space-y-8 bg-slate-50 border border-slate-100 rounded-xl shadow-sm">
                                ...
                                <div className="text-center space-y-2">
                                    ...
                                    <p className="text-slate-600 font-bold text-xs uppercase tracking-widest">Generating document map for editing...</p>
                                </div>
                            </div>
                        ) : (
                                    ...
                                    <AnimatePresence>
                                        {pages.map((page, index) => (
                                            ...
                                            >
                                                ...
                                                <div className="workspace-card-preview aspect-[3/4] relative">
                ...
                <AnimatePresence>
                    {organizedPdfUrl && (
                        ...
                        >
                            ...
                            <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-2">Organization Optimized</h3>
                            <p className="text-slate-500 font-medium max-w-md mb-8">
                                Your customized layout has been successfully applied and is ready for export.
                            </p>
                            ...
                            <div className="premium-file-details max-w-xl">
                                <div className="text-left">
                                    ...
                                    <p className="font-bold text-slate-800 text-sm truncate max-w-[200px] sm:max-w-[300px]">organized_document.pdf</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Status</p>
                                    <p className="font-bold text-[#0047AB] text-sm">{pages.length} Pages Compiled</p>
                                </div>
                            </div>
                            ...
                            <div className="premium-actions-layout">
                                ...
                                >
                                    <span className="btn-premium-action-text flex items-center gap-2">
                                        <Eye className="w-4 h-4" /> Check Layout
                                    </span>
                            ...
                            >
                                <RefreshCcw className="w-3.5 h-3.5" /> Organize Another File
                            </button>
                        </motion.div>
                    )}
                </AnimatePresence>
