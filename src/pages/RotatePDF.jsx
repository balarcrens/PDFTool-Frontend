                        ...
                        {isGeneratingPreviews ? (
                            <div className="flex flex-col items-center justify-center py-40 space-y-8 bg-slate-50 border border-slate-100 rounded-xl shadow-sm">
                                <div className="relative">
                                    <div className="w-20 h-20 border-4 border-slate-105 border-t-indigo-650 rounded-full animate-spin"></div>
                ...
                <AnimatePresence>
                    {rotatedPdfUrl && (
                        ...
                        >
                            ...
                            <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-2">Rotated Successfully</h3>
                            <p className="text-slate-500 font-medium max-w-md mb-8">
                                Your changes have been structurally written inside your browser. The file is ready for download.
                            </p>
                            ...
                            <div className="premium-file-details max-w-xl">
                                ...
                                <div className="text-right">
                                    ...
                                    <p className="font-bold text-indigo-600 text-sm">{pages.length} Pages Rotated</p>
                                </div>
                            </div>
                            ...
                            <div className="premium-actions-layout">
                                ...
                                >
                                    ...
                                    <span className="btn-premium-action-subtext">Open in browser</span>
                                </button>
                            ...
                            >
                                <RefreshCcw className="w-3.5 h-3.5" /> Rotate Another File
                            </button>
                        </motion.div>
                    )}
                </AnimatePresence>
